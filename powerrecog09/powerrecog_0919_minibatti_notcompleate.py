...
#imaginaly
  ...
  ydata_1 = datasetplus.reshape([(i+1)*80000])
...
for i in range(100000):
  ...
  sess.run(train_step, feed_dict={x: x_batch, t: ydata, keep_prob: 0.5})
  if i%100==0:
    summary, acc = sess.run([merged,accuracy], feed_dict={x: testdataset, t: testydata, keep_prob: 1.0})
    writer.add_summary(summary, i)
    acc_1 = sess.run(accuracy, feed_dict={x: x_batch, t: ydata, keep_prob: 1.0})
