...
#imaginaly
  ...
  dataset_batch_1 = tf.placeholder(tf.float32)
  ydata_batch_1 = tf.placeholder(tf.float32)
  testdataset = np.hstack((testdataset_1 , testdataset_2))

dataset_batch_1= tf.train.shuffle_batch([dataset], batch_size=100, capacity=50000, min_after_dequeue=10000)
dataset_batch = np.array(dataset_batch_1)
...
for i in range(100000):
  sess.run(train_step, feed_dict={x: dataset_batch, t: ydata, keep_prob: 0.5})
  if i%100==0:
