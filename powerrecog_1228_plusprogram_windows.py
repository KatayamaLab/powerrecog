...
data_LED = np.genfromtxt('/Users/uehara souta/Documents/powerrecog/data/led.txt', delimiter="\t", dtype= int)[:,2] - (2048)
data_fan = np.genfromtxt('/Users/uehara souta/Documents/powerrecog/data/fan.txt', delimiter="\t", dtype= int)[:,2] - (2048)
data_heater = np.genfromtxt('/Users/uehara souta/Documents/powerrecog/data/heater300.txt', delimiter="\t", dtype= int)[:,2] - (2048)
data_microwave = np.genfromtxt('/Users/uehara souta/Documents/powerrecog/data/microwave1.txt', delimiter="\t", dtype= int)[:,2] - (2048)
data_dryer = np.genfromtxt('/Users/uehara souta/Documents/powerrecog/data/dryer-low1.txt', delimiter="\t", dtype= int)[:,2] - (2048)
data_none = np.genfromtxt('/Users/uehara souta/Documents/powerrecog/data/none.txt', delimiter="\t", dtype= int)[:,2] - (2048)
...
###saver.save(sess, "./Parameter1204")


accgraph = accgraph_1*100
