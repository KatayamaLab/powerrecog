...
DATAFILES =  ['dryer-low1.txt','led.txt','fan.txt','heater300.txt','microwave1.txt','none.txt','microwave+LED.txt','microwave+fun.txt','microwave+dryer-low.txt','heater+LED.txt','microwave+heater.txt','heater+fun.txt','heater+dryer-low.txt','low+LED.txt','low+fan.txt','LED+fan.txt']

LABELS = ['dryer','LED','fan','heater','microwave','OFF', 'microwave+LED', 'microwave+fan', 'microwave+dryer', 'heater+LED','microwave+heater', 'heater+fan', 'heater+dryer', 'dryer+LED', 'dryer+fan', 'LED+fan']
...
writer = tf.summary.FileWriter("./studyrealimagmultioriginal", sess.graph)
...
saver.save(sess, "./Parameter0110original")


accgraph = accgraph_1*100
np.save('realimag_originaru_acc.npy', accgraph)
...
filename = "realimag_original_accuracy.png"
