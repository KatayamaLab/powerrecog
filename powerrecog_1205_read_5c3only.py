...
DATAFILES =  [data_none, data_microwave_LED_fan, data_microwave_LED_heater, data_microwave_LED_dryer, data_microwave_fan_heater, data_microwave_fan_dryer, data_microwave_heater_dryer, data_heater_LED_fan, data_heater_LED_dryer, data_heater_fan_dryer, data_dryer_LED_fan]
LABELS = ['OFF', 'microwave+led+fan', 'microwave+led+heater', 'microwave+led+dryer', 'microwave+fan+heater', 'microwave+fan+dryer', 'microwave+heater+dyer', 'heater+led+fan', 'heater+led+dryer', 'heater+fan+dryer', 'dryer+led+fan']
...
sess = tf.Session()
saver.restore(sess, "/home/pi/powerrecog_su/powerrecog12/Parameter1205_5c3only")
