...
DATAFILES =  [data_none, data_microwave_LED_fan_heater, data_microwave_LED_fan_dryer, data_microwave_LED_heater_dryer, data_microwave_fan_heater_dryer, data_heater_LED_fan_dryer]
LABELS = ['OFF', 'microwave+LED+fan+heater', 'microwave+LED+fan+dryer', 'microwave+LED+heater+dryer', 'microwave+fan+heater+dryer', 'heater+LED+fan+dryer']
...
saver.save(sess, "./Parameter1205_5c4only")
