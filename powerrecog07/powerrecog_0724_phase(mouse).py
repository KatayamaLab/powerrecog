...
y_1data = np.empty((0,OUTPUT_NUM), np.float32)
testy_1data = np.empty((0,OUTPUT_NUM), np.float32)
dataset_2 = np.empty((0,INPUT_NUM), np.float32)
testdataset_2 = np.empty((0,INPUT_NUM), np.float32)
y_2data = np.empty((0,OUTPUT_NUM), np.float32)
testy_2data = np.empty((0,OUTPUT_NUM), np.float32)
...
#imaginaly
  ...
  I = np.zeros([TRAIN_NUM, OUTPUT_NUM])
  I[:,i] = 1
  y_2data = np.append(y_2data, I, axis = 0)

  I = np.zeros([TEST_NUM, OUTPUT_NUM])
  I[:,i] = 1
