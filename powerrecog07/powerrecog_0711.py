...
# Data files
DATADIR = 'data/'
DATAFILES = ['dryer-hot1.txt','dryer-low1.txt','fan.txt','heater300.txt','microwave1.txt','none.txt','led.txt','dryer-cool1.txt','heater+microwave.txt','LED+microwave.txt','fun+microwave.txt','dryer-high+microwave.txt','dryer-low+microwave.txt']
LABELS = ['dryer-high','dryer-low','fan','heater','microwave', 'OFF', 'LED','dryer-cool','heater+microwave','LED+microwave','fun+microwave','dryer-high+microwave','dryer-low+microwave']
