...
# Data files
DATADIR = 'data/'
DATAFILES =  ['dryer-low1.txt','fan.txt','heater300.txt','microwave1.txt','none.txt','led.txt','microwave+LED_1.txt','microwave+fan_1.txt','microwave+dryer-low_1.txt','heater+LED_1.txt','microwave+heater_1.txt','heater+fun_1.txt','heater+dryer-low_1.txt','low+LED_1.txt','low+fan_1.txt','LED+fan_1.txt']
LABELS = ['dryer-low','fan','heater','microwave', 'OFF', 'LED','microwave+LED','microwave+fun','microwave+dryer-low','heater+LED','heater+microwave','heater+fun','heater+dryer-low', 'dryer-low+LED','dryer-low+fan','LED+fan']
