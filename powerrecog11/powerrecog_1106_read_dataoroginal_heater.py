...
# Data files
DATADIR = 'data/'
DATAFILES = ['dryer-low1.txt','fan.txt','heater300.txt','microwave1.txt','none.txt','led.txt','heater+LED.txt','heater+microwave.txt','heater+fun.txt','heater+dryer-low.txt']
LABELS = ['dryer-low','fan','heater','microwave', 'OFF', 'LED','heater+LED','heater+microwave','heater+fun','heater+dryer-low']
...
sess = tf.Session()
saver.restore(sess, "/home/pi/powerrecog_su/powerrecog11/Parameter1106_heater")
