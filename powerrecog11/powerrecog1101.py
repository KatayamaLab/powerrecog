...
# Data files
DATADIR = 'data/'
DATAFILES = ['dryer-hot1.txt','dryer-low1.txt','fan.txt','heater300.txt','microwave1.txt','none.txt','led.txt','dryer-cool.txt','heater+microwave.txt']
...
W2 = tf.Variable(tf.truncated_normal([HIDDEN_NUM, OUTPUT_NUM],stddev=1)) # weight
b2 = tf.Variable(tf.truncated_normal([OUTPUT_NUM],stddev=1)) # bias
y = tf.nn.softmax(tf.matmul(a1, W2) + b2) # output
