...
# Data files
DATADIR = 'data/'
DATAFILES = ['dryer-hot1.txt','dryer-low1.txt','fan.txt','heater300.txt','microwave1.txt','none.txt','led.txt','dryer-cool1.txt','microwave+heater_1.txt','heater+LED_1.txt','heater+fun_1.txt','heater+dryer-high_1.txt','heater+dryer-low_1.txt', 'heater+dryer-cool_1.txt']
LABELS = ['dryer-high','dryer-low','fan','heater','microwave', 'OFF', 'LED','dryer-cool','microwave+heater','heater+LED','heater+fun','heater+dryer-high','heater+dryer-low', 'heater+dryer-cool_1']
