...
# Data files
DATADIR = 'data/'
DATAFILES = ['dryer-low1.txt','fan.txt','heater300.txt','microwave1.txt','none.txt','led.txt','microwave+heater.txt','microwave+LED.txt','microwave+fun.txt','microwave+dryer-low.txt']
LABELS = ['dryer-low','fan','heater','microwave', 'OFF', 'LED','microwave+heater','microwave+LED','microwave+fun','microwave+dryer-low']
...
sess = tf.Session()
saver.restore(sess, "/home/pi/powerrecog_su/powerrecog11/Parameter1106_microwave)
