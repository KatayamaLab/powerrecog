...
DATAFILES =  [ data_none, data_microwave_LED, data_microwave_fan, data_microwave_heater, data_microwave_dryer, data_heater_LED, data_heater_fan, data_heater_dryer, data_dryer_LED, data_dryer_fan, data_LED_fan]
LABELS = ['OFF', 'microwave+LED', 'microwave+fan', 'microwave+heater', 'microwave+dryer', 'heater+LED', 'heater+fan', 'heater+dryer', 'dryer+LED', 'dryer+fan', 'LED+fan']
...
sess = tf.Session()
saver.restore(sess, "/home/pi/powerrecog_su/powerrecog12/Parameter1205_5c2only")
