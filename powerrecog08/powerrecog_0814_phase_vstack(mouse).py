...
testdataset = np.vstack((testdataset_1 , testdataset_2))
...
W1 = weight_variable1([INPUT_NUM, HIDDEN_NUM]) # weight
b1 = bias_variable([HIDDEN_NUM]) # bias
a1 = tf.nn.tanh(tf.matmul(x, W1) + b1) # output
W2 = weight_variable2([HIDDEN_NUM, HIDDEN_NUM]) # weight
b2 = bias_variable([HIDDEN_NUM]) # bias
a2 = tf.nn.tanh(tf.matmul(a1, W2) + b2) # output
W3 = weight_variable3([HIDDEN_NUM, HIDDEN_NUM]) # weight
b3 = bias_variable([HIDDEN_NUM]) # bias
a3 = tf.nn.tanh(tf.matmul(a2, W3) + b3) # output
W4 = weight_variable2([HIDDEN_NUM, HIDDEN_NUM]) # weight
b4 = bias_variable([HIDDEN_NUM]) # bias
a4 = tf.nn.tanh(tf.matmul(a3, W4) + b4) # output
W5 = weight_variable3([HIDDEN_NUM, OUTPUT_NUM]) # weight
b5 = bias_variable([OUTPUT_NUM]) # bias

y = tf.nn.softmax(tf.matmul(a4, W5) + b5) # output
...
correct_prediction_1 = tf.equal(tf.argmax(y,1), tf.argmax(y,1))
