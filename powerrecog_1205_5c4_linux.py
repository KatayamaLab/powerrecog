...
data_microwave_LED_fan_heater = data_microwave + data_LED + data_fan +data_heater
data_microwave_LED_fan_dryer = data_microwave + data_LED + data_fan +data_dryer
data_microwave_LED_heater_dryer = data_microwave + data_LED + data_heater +data_dryer
data_microwave_fan_heater_dryer = data_microwave + data_fan + data_heater + data_dryer
data_heater_LED_fan_dryer = data_heater + data_LED + data_fan + data_dryer



DATAFILES =  [data_dryer, data_LED, data_fan, data_heater, data_microwave, data_none, data_microwave_LED, data_microwave_fan, data_microwave_heater, data_microwave_dryer, data_heater_LED, data_heater_fan, data_heater_dryer, data_dryer_LED, data_dryer_fan, data_LED_fan, data_microwave_LED_fan, data_microwave_LED_heater, data_microwave_LED_dryer, data_microwave_fan_heater, data_microwave_fan_dryer, data_microwave_heater_dryer, data_heater_LED_fan, data_heater_LED_dryer, data_heater_fan_dryer, data_dryer_LED_fan, data_microwave_LED_fan_heater, data_microwave_LED_fan_dryer, data_microwave_LED_heater_dryer, data_microwave_fan_heater_dryer, data_heater_LED_fan_dryer]
LABELS = ['dryer','LED','fan','heater','microwave','OFF', 'microwave+LED', 'microwave+fan', 'microwave+heater', 'microwave+dryer', 'heater+LED', 'heater+fan', 'heater+dryer', 'dryer+LED', 'dryer+fan', 'LED+fan', 'microwave+led+fan', 'microwave+led+heater', 'microwave+led+dryer', 'microwave+fan+heater', 'microwave+fan+dryer', 'microwave+heater+dyer', 'heater+led+fan', 'heater+led+dryer', 'heater+fan+dryer', 'dryer+led+fan', 'microwave+LED+fan+heater', 'microwave+LED+fan+dryer', 'microwave+LED+heater+dryer', 'microwave+fan+heater+dryer', 'heater+LED+fan+dryer']
...
saver.save(sess, "./Parameter1205_5c4")
